...
# Before starting, make sure all the directories exist
...
# Open the file writer for the current session with the scapping date
filename = f'IG-data-{date.today()}.csv'
csv_file = open(results_dir/filename, 'w', encoding='utf-8')
...
with open(imgs_dir/'background.jpg', 'wb') as f:
...
while True:
    ...
    for item in items:
        ...
        with open(imgs_dir/f'{numero_id}.jpg', 'wb') as f:
